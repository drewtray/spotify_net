# AUTOGENERATED! DO NOT EDIT! File to edit: ../03_hit_endpoint.ipynb.

# %% auto 0
__all__ = ['p_dict', 'load_s3', 'prep_frame', 'make_request', 'cred', 'add_tracks', 'delete_tracks']

# %% ../03_hit_endpoint.ipynb 2
import pandas as pd
import requests
import boto3
import base64
